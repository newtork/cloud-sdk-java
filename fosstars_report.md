...
**Score**: **2.82**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **7.85** (weight is 0.5)
...
1.  [Suggest a security policy for the project](https://github.com/newtork/cloud-sdk-java/security/policy)
